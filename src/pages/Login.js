...
const Login = ({ onLoginCorredor, onLoginCliente }) => {
  ...
  /* ── Tab principal: 'cliente' | 'corredor' ── */
  ...
  /* ════════════════════════════
     LOGIN cliente — usuario + contraseña
  ════════════════════════════ */
  ...
  const tituloIzq = isCliente ? <>Portal de<br />Clientes</> : <>Panel de<br />Administración</>;
  const subtitoIzq = isCliente
      ...
      <div className="login-page">
        ...
        <div className="login-left">
          ...
          <div className="login-left-content">
            ...
            <h1 className="login-left-titulo">{tituloIzq}</h1>
            <p className="login-left-subtitulo">{subtitoIzq}</p>
            <div className="login-stats">
              {statsIzq.map(([icon, label]) => (
        ...
        <div className="login-right">
          <div className="login-card">
            ...
            {/* Tabs principales: Cliente / Corredor */}
                  ...
                  <>
                    <form onSubmit={handleClienteLogin} className="login-form" noValidate>
                      ...
                      <p className="login-switch-hint">
                        ¿No tienes cuenta?{' '}
                        <button type="button" className="login-link" onClick={() => cambiarSubTab('registro')}>
                          Créala aquí
                        </button>
                      </p>
                ...
                {subTab === 'registro' && (
                  <>
                    <form onSubmit={handleClienteRegistro} className="login-form" noValidate>
                      ...
                      <div className="login-opcionales">
                      ...
                      {!regData.email && (
                        <div className="login-aviso-email">
                          ⚠️ Sin correo no podrás recuperar tu contraseña si la olvidas.
                          Te recomendamos agregarlo.
                        </div>
                      )}
                    ...
                    <div className="login-divider">
                      <div className="login-divider-line" />
                      <span className="login-divider-text">o regístrate con</span>
                      <div className="login-divider-line" />
                    </div>
            ...
            {tab === 'corredor' && (
              <>
                ...
                <div className="login-google-btn">
                  <GoogleLogin
                    onSuccess={handleGoogleCorredor}
                    onError={() => setError('Error al iniciar sesión con Google.')}
                    theme="outline" size="large" width="300" text="signin_with" locale="es"
                  />
                </div>
