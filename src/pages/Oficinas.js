  ...
  useEffect(() => {
    ...
    axios.get(`${API_BASE}/properties`)
      .then((res) => {
        ...
        setTodasPropiedades(oficinas);
        setPropiedadesFiltradas(aplicarFiltrosURL(oficinas, location.search));
      })
      .catch(() => {})
      ...
      <Row>
        ...
        <Col xs={12} md={8} lg={9}>
          <Row className="mb-3 align-items-center">
            <Col>
              <h4 style={{ color: '#3f1b86', fontWeight: 700 }}>Oficinas</h4>
          ...
          {cargando ? (
            ...
            <div className="text-center py-5">
              ...
              <h5 className="text-muted">Próximamente nuevas oficinas</h5>
